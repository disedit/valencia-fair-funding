...
<div class="module module-manifesto">
  <div class="module-content">
    <div class="col-sm-6">
      <a href="{{ $permalink }}" class="manifesto-title"><h2><i class="far fa-file-alt"></i> <?php pll_e('Manifest', 'fair-funding') ?></h2></a>
    </div>
    ...
    <a href="{{ $permalink }}" data-title="@php(the_title())" data-container="page-content" class="btn btn-light btn-lg btn-block">
      <span class="text"><?php pll_e('Continua llegint...', 'fair-funding') ?></span>
